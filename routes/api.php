...
Route::post('players/{player}/games', [ShotController::class, 'store'])->name('shots.store');  // un jugador específic realitza una tirada dels daus.
Route::delete('players/{player}/games', [ShotController::class, 'destroy'])->name('shots.destroy');  // elimina les tirades del jugador
...
Route::get('players/{player}/games', [ShotController::class, 'show'])->name('playershots.index');  // retorna el llistat de jugades per un jugador.
